...
public class Bucha extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bucha);
    ...
    public void calcularAbobRast(View v){
        ...
        if (this.X.getText().toString().isEmpty()|| this.Y.getText().toString().isEmpty()||
            ...
            superfosfato.setText(String.valueOf(calculo.SSgBerinjela()));
            fte.setText("5");
            calagem.setText(String.valueOf(calculo.calagem()));
            trintadias.setText("10");
            sessentadias.setText("10");
            noventadias.setText("15");
