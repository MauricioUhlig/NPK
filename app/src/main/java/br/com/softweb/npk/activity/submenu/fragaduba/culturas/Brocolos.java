...
public class Brocolos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_brocolos);
    ...
    public void calcularAbobRast(View v){
        ...
        if (this.X.getText().toString().isEmpty()|| this.Y.getText().toString().isEmpty()||
            ...
            superfosfato.setText(String.valueOf((calculo.SSgBrocolos()/(10000/(x*y)))*1000*5));
            fte.setText("3");
