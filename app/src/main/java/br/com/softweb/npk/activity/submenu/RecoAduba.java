...
public class RecoAduba extends AppCompatActivity {
    ...
    public void recCacau (View v){
        Intent it = new Intent(this, Cacau.class);
        startActivity(it);
    }
    public void recCafeArabica (View v){
    ...
    public void recCana(View v){
        Intent it = new Intent(this, Cana.class);
        startActivity(it);
    }
    public void recCaqui(View v){
        Intent it = new Intent(this, Caqui.class);
        startActivity(it);
    }
}
