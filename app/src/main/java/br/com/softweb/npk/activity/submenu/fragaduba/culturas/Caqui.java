    ...
    import br.com.softweb.npk.activity.submenu.repetentes.Fragment_Plantio3V70;
    ...
    public class Caqui extends AppCompatActivity {
        ...
        private void setupViewPager(ViewPager viewPager) {
            ...
            adapter.addFrag(new Fragment_Plantio3V70(), getText(R.string.plantio).toString());
        ...
        public void calcularPlantio(View v){
            ...
            if (this.X.getText().toString().isEmpty()|| this.Y.getText().toString().isEmpty()|| this.Z.getText().toString().isEmpty()||
                ...
                sessentadias.setText("60");
                noventadias.setText("80");
        ...
        public void calcularTresano(View v){
            ...
            gramasf3L1.setText(""+5*calcula.fosforoCaqui(1));
        ...
        public void calcularQuartoano(View v){
            ...
            gramasf4L1.setText(""+5*calcula.fosforoCaqui(2));
            TextView gramasf4L2 = (TextView) findViewById(R.id.gramasf4L2);
            gramasf4L2.setText("500");
            String adubo = calcula.adubo4parametros(60,120,200,280);
