    ...
    import br.com.softweb.npk.activity.submenu.repetentes.ObservacoesCacau;
    import br.com.softweb.npk.activity.submenu.repetentes.Substrato;
    import br.com.softweb.npk.calculo.CalculoGeral;


    public class Cacau extends AppCompatActivity {
        ...
        private void setupViewPager(ViewPager viewPager) {
            ...
            adapter.addFrag(new ObservacoesCacau(),getText(R.string.tit_obs).toString());
        ...
        public void calcularPlantio(View v){
            ...
            if (this.X.getText().toString().isEmpty()|| this.Y.getText().toString().isEmpty()|| this.Z.getText().toString().isEmpty()||
                ...
                esterco.setText(String.valueOf((int)calculo.esterco()));
                superfosfato.setText(String.valueOf((int)calculo.SSg()));
                calcario.setText(String.valueOf((int)calculo.calcarioGcova()));
                fte.setText("20");
                calagem.setText(String.valueOf(calculo.calagem()));
                trintadias.setText("25");
                sessentadias.setText("40");
                noventadias.setText("50");
        ...
        public void calcularDoisano(View v){
            ...
            gramasf2L1.setText(""+5*(int)calcula.fosforo());
        ...
        public void calcularProducao(View v){
            ...
            this.y = Float.parseFloat(Y.getText().toString());
          //  this.z = Float.parseFloat(Z.getText().toString());
            densidade.setText("= "+(int)(10000/(x*y))+" ");
            int var;
            if (p_meh<10)var=150;
            else if (p_meh>=10 && p_meh<20)var=100;
            else if (p_meh>=20 && p_meh<50)var= 40;
            else var=0;
            var=(int)(1000*((5*var)/(10000/(x*y))));
            TextView gramaPl1 = (TextView) findViewById(R.id.gramasPL1);
            gramaPl1.setText(""+var);
            var= (int)((1000*((140*5)/(10000/(x*y))))/3);
        ...
        public void calcularCalagemP(View v){
            ...
            calagem.setText(String.format("" + calcula.calagem()));
        }
    }
